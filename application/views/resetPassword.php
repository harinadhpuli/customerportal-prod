        ...
        <div class="app-container">
            <div class="h-100">
                <div class="h-100 no-gutters row">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-4 col-lg-4">
                            ...
                            <div>
                             ...
                             <?php echo $this->messages->getMessageFront(); 
                              ...
                              <!--  <form class="" autocomplete="off" action="<?php echo base_url()?>login/userlogin" method="post"> -->
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="position-relative form-group"><label for="exampleEmail" class="">Security Token</label>
                                            <input name="security_token" id="exampleEmail" placeholder="Security Token" type="text" value="<?php if(isset($formData['security_token'])){echo $formData['security_token'];} ?>" class="form-control" autocomplete="off"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            ...
                                            <input name="password" id="exampleEmail" placeholder="Password" type="password"  class="form-control" autocomplete="off"></div>
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="position-relative form-group"><label for="exampleEmail" class="">Confirm Password</label>
                                            <input name="confirm_password" id="exampleEmail" placeholder="Confirm Password" type="password"  class="form-control" autocomplete="off"></div>
                                        </div>
                                    </div>
